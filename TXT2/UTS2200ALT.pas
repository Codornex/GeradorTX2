...
type
  TS2200ALT = class(TObjectList)
  private
    function GetItem(Index: Integer): TS2200ALT;
    function Add: TS2200ALT;
  public
    indRetif_4: String;
    tpAmb_6: String;
    procEmi_7: String;
    ...
    property Items[Index: Integer]: TS2200ALT read GetItem; default;
    procedure GetS2200ALT(const Arq: TStringList);
  end;
...
function TS2200ALT.Add: TS2200ALT;
begin
  Result := TS2200ALT.Create;
  inherited Add(Result);
end;

function TS2200ALT.GetItem(Index: Integer): TS2200ALT;
begin
  Result := TS2200ALT(inherited Items[Index]);
end;

procedure TS2200ALT.GetS2200ALT(const Arq: TStringList);
var
  I: Integer;
  Lista: TStringList;
begin
  ...
  for I := 0 to Pred(Arq.Count) do
    if Copy(Arq[I], 0, Pred(Pos('|', Arq[I]))) = 'S2200ALT' then
    begin
